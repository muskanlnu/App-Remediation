...
const ResultTab = ({
  ...
  const requestUrl = `http://localhost:8080/cloudblockers/getblockers?filePath=${encodedFilePath}`;
  const postUrl = `http://localhost:8080/cloudblockers/saveblockers`;
...
const PreviousResultsTab = ({
  ...
  const requestUrl = `http://localhost:8080/cloudblockers/getallblockers`;
